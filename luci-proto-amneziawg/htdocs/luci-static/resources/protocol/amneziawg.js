...
return network.registerProtocol("amneziawg", {
    ...
    renderFormOptions: function (s) {
        ...
        // Добавление параметров I1-I5 для AmneziaWG 1.5
        o = s.taboption(
            "amneziawg",
            form.Value,
            "awg_i1",
            _("I1"),
            _("First signature packet for protocol imitation (CPS format)")
        );
        o.datatype = "string";
        o.optional = true;
        o.placeholder = "e.g., <b 0xc200...>";
        ...
        o = s.taboption(
            ...
            "awg_i2",
            _("I2"),
            _("Second signature packet (optional)")
        );
        o.datatype = "string";
        o.optional = true;
        ...
        o = s.taboption(
            ...
            "awg_i3",
            _("I3"),
            _("Third signature packet (optional)")
        );
        o.datatype = "string";
        o.optional = true;
        ...
        o = s.taboption(
            ...
            "awg_i4",
            _("I4"),
            _("Fourth signature packet (optional)")
        );
        o.datatype = "string";
        o.optional = true;
        ...
        o = s.taboption(
            ...
            "awg_i5",
            _("I5"),
            _("Fifth signature packet (optional)")
        );
        o.datatype = "string";
        o.optional = true;
        ...
        ss.parseConfig = function (data) {
            ...
            for (var i = 0; i < lines.length; i++) {
                ...
                if (line.match(/^\[(\w+)\]$/)) {
                    ...
                    // Добавление обработки параметров I1-I5
                    if (['i1', 'i2', 'i3', 'i4', 'i5'].includes(key.toLowerCase())) {
                        s[section + '_' + key.toLowerCase()] = val;
                    }
                    else if (val.length) s[section + '_' + key.toLowerCase()] = val;
                }
            }
            ...
            if (mode == "full") {
                ...
                return getPublicAndPrivateKeyFromPrivate(config.interface_privatekey)
                    .then(function (keypair) {
                        ...
                        // Установка значений I1-I5
                        s.getOption("awg_i1")
                            .getUIElement(s.section)
                            .setValue(config.interface_i1 || "");
                        s.getOption("awg_i2")
                            .getUIElement(s.section)
                            .setValue(config.interface_i2 || "");
                        s.getOption("awg_i3")
                            .getUIElement(s.section)
                            .setValue(config.interface_i3 || "");
                        s.getOption("awg_i4")
                            .getUIElement(s.section)
                            .setValue(config.interface_i4 || "");
                        s.getOption("awg_i5")
                            .getUIElement(s.section)
                            .setValue(config.interface_i5 || "");
        ...
        o.createPeerConfig = function (section_id, endpoint, ips, eips, dns) {
            ...
            return [
                ...
                "H3 = " + h3,
                "H4 = " + h4,
                // Добавление параметров I1-I5 если они заданы
